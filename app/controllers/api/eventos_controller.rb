class Api::EventosController < Api::ApiController
  ...
  def build_evento(evento = nil)
    ...
    evento_attributes = params.permit(:nome, :descricao, :data, :hora, :website,
      :facebook, :responsavel_uuid, :uuid, :data_fim,
      esportes: [:id],
      local: [:latitude, :longitude, :logradouro, :numero, :complemento, :bairro,
