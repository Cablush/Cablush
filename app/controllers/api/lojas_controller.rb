class Api::LojasController < Api::ApiController
  ...
  def build_loja(loja = nil)
    ...
    loja_attributes = params.permit(:nome, :descricao, :telefone, :email, :website,
      :facebook, :responsavel_uuid, :uuid,
      esportes: [:id],
      horario: [:inicio, :fim, :seg, :ter, :qua, :qui, :sex, :sab, :dom, :detalhes],
      locais: [:latitude, :longitude, :logradouro, :numero, :complemento, :bairro,
