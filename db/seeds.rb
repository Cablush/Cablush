...
unless Estado.exists?
  c_br = Country.where('iso = ?', 'BR');
  Estado.create(rg: "AC", nome: "Acre", country_id: c_br.id)
  Estado.create(rg: "AL", nome: "Alagoas", country_id: c_br.id)
  Estado.create(rg: "AP", nome: "Amapa", country_id: c_br.id)
  Estado.create(rg: "AM", nome: "Amazonas", country_id: c_br.id)
  Estado.create(rg: "BA", nome: "Bahia", country_id: c_br.id)
  Estado.create(rg: "CE", nome: "Ceara", country_id: c_br.id)
  Estado.create(rg: "DF", nome: "Distrito Federal", country_id: c_br.id)
  Estado.create(rg: "ES", nome: "Espírito Santo", country_id: c_br.id)
  Estado.create(rg: "GO", nome: "Goias", country_id: c_br.id)
  Estado.create(rg: "MA", nome: "Maranhão", country_id: c_br.id)
  Estado.create(rg: "MG", nome: "Minas Gerais", country_id: c_br.id)
  Estado.create(rg: "MT", nome: "Mato Grosso", country_id: c_br.id)
  Estado.create(rg: "MS", nome: "Mato Grosso do Sul", country_id: c_br.id)
  Estado.create(rg: "PA", nome: "Pará", country_id: c_br.id)
  Estado.create(rg: "PB", nome: "Paraíba", country_id: c_br.id)
  Estado.create(rg: "PR", nome: "Paraná", country_id: c_br.id)
  Estado.create(rg: "PE", nome: "Pernambuco", country_id: c_br.id)
  Estado.create(rg: "PI", nome: "Piauí", country_id: c_br.id)
  Estado.create(rg: "RJ", nome: "Rio de Janeiro", country_id: c_br.id)
  Estado.create(rg: "RN", nome: "Rio Grande do Norte", country_id: c_br.id)
  Estado.create(rg: "RS", nome: "Rio Grande do Sul", country_id: c_br.id)
  Estado.create(rg: "RR", nome: "Roraima", country_id: c_br.id)
  Estado.create(rg: "RO", nome: "Rondônia", country_id: c_br.id)
  Estado.create(rg: "SC", nome: "Santa Catarina", country_id: c_br.id)
  Estado.create(rg: "SE", nome: "Sergipe", country_id: c_br.id)
  Estado.create(rg: "SP", nome: "São Paulo", country_id: c_br.id)
  Estado.create(rg: "TO", nome: "Tocantins", country_id: c_br.id)
end
# Estados - end